...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.StudentYear.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Section.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Semester.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.StudentAttendance.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Periods.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Subject.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.mycompany.myapp.domain.CollegeBranches.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.mycompany.myapp.domain.College.class.getName(), jcacheConfiguration);
