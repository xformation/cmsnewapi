    ...
    describe('Semester Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/semesters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Semester', () => {
                service.create(new Semester(null)).subscribe(received => {
            ...
            it('should update a Semester', () => {
                service.update(new Semester(123)).subscribe(received => {
