    ...
    describe('College Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/colleges';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a College', () => {
                service.create(new College(null)).subscribe(received => {
            ...
            it('should update a College', () => {
                service.update(new College(123)).subscribe(received => {
